...
const main = async () => {
  ...
  //Instance of the class Accounts
  const $accounts = new Accounts();

  //Returns an array with all the created users coming from the database.
  ...
  do {
    ...
    switch (opt) {
      ...
      case "6":
        ...
        const transferInformation = await $accounts.checkTransactions(
          checkTransactionsId
        );
